...
// JPasswordField password = new JPassword();
// String setPassword = new String(password.getPassword());

//publis static void main(String[] sargs) hello worl Sheesh thta is crazy bro